...
- Name: images.spec.ts >> Images >> right-click image opens context menu @smoke
- Location: src\__tests__\playwright\images.spec.ts:49:7
...
Locator: locator('.context-menu, [class*="context-menu"], [class*="image-context"]').first()
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('.context-menu, [class*="context-menu"], [class*="image-context"]').first()
