...
- Name: ai-actions.spec.ts >> AI Actions >> AI refine toolbar button sends postMessage @smoke
- Location: src\__tests__\playwright\ai-actions.spec.ts:30:7
...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e41]:
      - button "✨ AI Refine" [active] [ref=e42] [cursor=pointer]
