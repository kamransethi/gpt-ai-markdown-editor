...
- Name: bubble-menu.spec.ts >> Bubble Menu >> bubble menu AI refine button is present @smoke
- Location: src\__tests__\playwright\bubble-menu.spec.ts:230:7
...
- generic [ref=e1]:
  ...
  - textbox [active] [ref=e47]:
    - paragraph [ref=e48]: AI refine test
