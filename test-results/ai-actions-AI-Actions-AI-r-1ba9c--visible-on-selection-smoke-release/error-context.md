...
- Name: ai-actions.spec.ts >> AI Actions >> AI refine in bubble menu visible on selection @smoke
- Location: src\__tests__\playwright\ai-actions.spec.ts:46:7
...
- generic [ref=e1]:
  ...
  - textbox [active] [ref=e47]:
    ...
    - paragraph [ref=e49]:
      ...
      - link "here.Select" [ref=e50]:
        - /url: http://here.Select
      - text: this
