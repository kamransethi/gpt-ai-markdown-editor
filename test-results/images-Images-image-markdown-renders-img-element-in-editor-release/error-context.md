...
- Name: images.spec.ts >> Images >> image markdown renders <img> element in editor
- Location: src\__tests__\playwright\images.spec.ts:35:7
...
Locator: locator('.ProseMirror img')
Expected: visible
Error: strict mode violation: locator('.ProseMirror img') resolved to 2 elements:
    1) <img alt="Alt text" class="markdown-image" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==" data-markdown-src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg=="/> aka getByRole('img', { name: 'Alt text' })
    2) <img alt="" class="ProseMirror-separator"/> aka locator('img').nth(1)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('.ProseMirror img')
