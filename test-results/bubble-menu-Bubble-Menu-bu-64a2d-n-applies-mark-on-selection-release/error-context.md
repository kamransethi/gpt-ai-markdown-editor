...
- Name: bubble-menu.spec.ts >> Bubble Menu >> bubble menu italic button applies mark on selection
- Location: src\__tests__\playwright\bubble-menu.spec.ts:222:7
...
- generic [ref=e1]:
  ...
  - textbox [active] [ref=e47]:
    - paragraph [ref=e48]: Bubble italic
